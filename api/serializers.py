...
class RoleSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Role
        fields = ['id', 'name', 'description','color', 'permissions', 'users','tableau','distributeurs','commerciaux','prospects','inventaire','commande','utilisateur','analytique','geolocalisation','configuration','positions','createcommande','vuecommande']
